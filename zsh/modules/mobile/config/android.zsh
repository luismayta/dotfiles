...
export ANDROID_PLATFORM_VERSION="${JASPER_ANDROID_PLATFORM_VERSION:-37}"
export ANDROID_SDK_VERSION="${JASPER_ANDROID_SDK_VERSION:-37.0.0}"
export ANDROID_FILE_REPOSITORIES="${HOME}/.android/repositories.cfg"
export ANDROID_CMDLINE_TOOLS_VERSION="${JASPER_ANDROID_CMDLINE_TOOLS_VERSION:-11076708}"

# SDKMAN / Java provisioning
export SDKMAN_INSTALL_URL="${SDKMAN_INSTALL_URL:-https://get.sdkman.io?rcupdate=false}"
export SDKMAN_JAVA_VERSION="${JASPER_SDKMAN_JAVA_VERSION:-17.0.13-tem}"
