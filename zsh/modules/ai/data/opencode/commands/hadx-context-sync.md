...
3. Compare `.opencode/context/`, `.opencode/agent/`, `.opencode/skills/`, `.opencode/commands/`, `.opencode/config/`, `.agents/skills/`, `opencode.jsonc`, and `AGENTS.md` against the current repository structure and source-of-truth files defined by the skill.
