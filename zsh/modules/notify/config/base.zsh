...
export ZSH_NOTIFY_CONFIG_PATH="${HOME}/.config/notify"

export ZSH_NOTIFY_DATA_PATH="${ZSH_NOTIFY_PATH}/data"
export ZSH_NOTIFY_DATA_SHARE_PATH="${ZSH_NOTIFY_DATA_PATH}/notify"

export ZSH_NOTIFY_ASSETS_PATH="${ZSH_NOTIFY_DATA_SHARE_PATH}/assets"
