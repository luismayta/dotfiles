...
2.  Create a Fork and open a [Pull Request](https://github.com/luismayta/dotfiles/pull-requests/) if needed

### Code Review

- Anyone can review code
- Any [Pull Request](https://github.com/luismayta/dotfiles/pull-requests/) should be closed or merged within a week
