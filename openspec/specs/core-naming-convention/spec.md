...
Define y aplica la convención de nombres `core::*::*` para las funciones del módulo `zsh/core/`, asegura que todos los callers usen los nuevos nombres, y consolida las implementaciones duplicadas de `reload`.
