...
Unify the colorscheme across all configurable tools in the dotfiles by migrating everything to TokyoNight, removing all Catppuccin references from active configurations, and letting tools without explicit theme support inherit TokyoNight colors from the terminal emulator.
