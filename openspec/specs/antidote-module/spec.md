...
Módulo zsh de antidote en `zsh/system/antidote` que registra el loader, instala antidote idempotentemente, inicia los bundles preservando orden, y elimina el mecanismo legacy de tools.
