...
Standalone CLI commands for managing git worktrees — creating, listing, and deleting worktrees via dedicated `hrdw-*` commands, with executable scripts tracked in git.
