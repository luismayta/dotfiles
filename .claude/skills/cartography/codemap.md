...
- Direct children: scripts/.
- Detected 18 function-like declaration(s) and 2 class declaration(s).
...
- External dependencies: Dict, Path, argparse, cartographer, datetime, hashlib, json, os.
