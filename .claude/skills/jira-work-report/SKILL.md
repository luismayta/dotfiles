...
Usa este skill cuando quieras dejar un comentario estructurado en Jira con el resumen de lo implementado sin redactarlo manualmente. El skill detecta si el proyecto usa Jira desde `codi.toml`, obtiene el `projectKey`, deriva el issue key desde el branch actual, toma como base el template `.codi/jira/issue_templates/jira-work-report.md`, resume los commits recientes del branch y publica el resultado como comentario en el issue derivado.
