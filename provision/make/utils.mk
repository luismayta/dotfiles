...
utils.generate:
	mkdir -p ${KEYBASE_PATH}/${stage}/{pem,pub,private,openssl}
	mkdir -p ${KEYBASE_PATH}/${stage}/pub
	mkdir -p ${KEYBASE_PATH}/${stage}/private
	...
	cp -rf ${PROJECT}-${stage}.pem ${KEYBASE_PATH}/${stage}/pem/
	cp -rf ${PROJECT}-${stage}.pub ${KEYBASE_PATH}/${stage}/pub/
	cp -rf ${PROJECT}-${stage} ${KEYBASE_PATH}/${stage}/private/
